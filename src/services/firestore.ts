...
const backfillDefaults = async () => {
  console.log('backfillDefaults');
  let q = query(questionsCollection)
  console.log("qiery: ",q)
  q = query(q, where('subjectArea', '==', 'All'))
...
export const deleteQuestion = async (questionId: string) => {
  ...
  console.log('deleteddeleteddeleteddeleteddeleteddeleteddeleted')
};
